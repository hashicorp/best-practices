...
output "haproxy_private_fqdn" {
  value = "${module.haproxy.private_fqdn}"
}

output "haproxy_public_fqdn" {
  value = "${module.haproxy.public_fqdn}"
}

output "nodejs_blue_elb_zone_id" {
  value = "${module.nodejs.blue_elb_zone_id}"
}

output "nodejs_blue_private_fqdn" {
  value = "${module.nodejs.blue_private_fqdn}"
}

output "nodejs_blue_elb_dns" {
  value = "${module.nodejs.blue_elb_dns}"
}

output "nodejs_green_elb_zone_id" {
  value = "${module.nodejs.green_elb_zone_id}"
}

output "nodejs_green_private_fqdn" {
  value = "${module.nodejs.green_private_fqdn}"
}

output "nodejs_green_elb_dns" {
  value = "${module.nodejs.green_elb_dns}"
}
